import { AppBar, Button, Drawer, Grid, IconButton, makeStyles, Toolbar, Typography, Theme, createStyles, List, ListItemIcon, ListItemText, ListItem, ListItemSecondaryAction, Switch, Divider, createTheme, useTheme } from '@material-ui/core';
...
function HeaderReducer(state: any, action: ReducerAction): any{ 
    ...
    switch (type) {
        ...
        case 'closeDrawer':
            return {...state, showDrawer: false, showPlaylists: false, showScoresMods: false}
        ...
        case 'resetScores':
            ...
            return{...state, showScoresMods: false}
        default:
            return state;
    }
}
export const Header: React.FC = () => {
    ...
    const {showDrawer, showPlaylists, showScoresMods, stickyScores} = state;
            ...
            <div>
                ...
                <Drawer anchor={'left'} open={showDrawer} onClose={()=>dispatch({type: 'closeDrawer'})} classes={{paper: style.paper}}>
                    <List>
                        ...
                        <ListItem button onClick={()=>setSettings({...settings, easyMode: !settings.easyMode})}>
                        ...
                        <>
                            ...
                            {PLAYLISTS.map((playlist, index)=>
                                <ListItem key={index} button onClick={()=>setSettings({...settings, playlist: playlist})}>
                                <ListItemIcon><PlaylistPlayIcon /></ListItemIcon>
                        ...
                        { showScoresMods &&
                            ...
                            <ListItem button onClick={()=>setSettings({...settings, stickyScores: !settings.stickyScores})}>
                            <ListItemIcon><ImportExportIcon/></ListItemIcon>
